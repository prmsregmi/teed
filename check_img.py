...
gt_mat_path = "result/gt_mat/02-0868x4.mat"
...
gt_struct = gt_data["groundTruth"][0]
# print(gt_struct[0][0].shape)
# max_val = np.max(gt_struct.ravel()[0])
# max_val = np.max(gt_struct['Boundaries'][0][0][0])
max_val = np.max(gt_struct[0][0][0][0])
print(max_val)
# print(type(gt_struct), gt_struct[0].shape)
